...
class DetailedSolutionSerializers(serializers.Serializer):
    ...
    description = serializers.CharField(allow_blank=True, read_only=True)
    transportation = serializers.CharField(allow_blank=True, read_only=True)
    price = serializers.CharField(allow_blank=True, read_only=True)
    environment = serializers.CharField(allow_blank=True, read_only=True)
    rooms = serializers.CharField(allow_blank=True, read_only=True)
    rank = serializers.CharField(allow_blank=True, read_only=True)
    livingArea = serializers.CharField(allow_blank=True, read_only=True)
    plotArea = serializers.CharField(allow_blank=True, read_only=True)
    kindOfHouse = serializers.CharField(allow_blank=True, read_only=True)
    energyLabel = serializers.CharField(allow_blank=True, read_only=True)
    constructionYear = serializers.CharField(allow_blank=True, read_only=True)
    suitableFor = serializers.CharField(allow_blank=True, read_only=True)
